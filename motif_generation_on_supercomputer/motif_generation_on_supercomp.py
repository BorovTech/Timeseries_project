...
ot_f = open("ot_f_data.txt", 'w')
ot_f.write("checkpoint after data loaded")
ot_f.close()
    
        
threads = [threading.Thread(target=motif_duckery, args=[clustering_data, x]) for x in patterns_for_supercomp[:12]]
